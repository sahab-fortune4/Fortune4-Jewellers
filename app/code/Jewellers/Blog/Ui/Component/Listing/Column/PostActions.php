...
namespace jewellers\Blog\Ui\Component\Listing\Column;
...
{
    private const URL_PATH_EDIT = 'jewellers_blog/post/edit';
    private const URL_PATH_DELETE = 'jewellers_blog/post/delete';
