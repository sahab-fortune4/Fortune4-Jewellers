...
use Jewellers\FormSubmission\Model\Submission as SubmissionModel;
...
class Save extends \Magento\Backend\App\Action
{
     ...
     * @param SubmissionModel $logisticsData
     * @param Session $adminsession
     */
    public function __construct(
        Action\Context $context,
        SubmissionModel $logisticsModalData,
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            // die;
            // $data['product_id'] = 0;
            $form_id = $this->getRequest()->getParam('entity_id');
            if ($form_id) {
                $this->logisticsData->load($form_id);
