...
class Interceptor extends \Magento\Shipping\Block\Tracking\Popup implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTrackingInfo');
        return $pluginInfo ? $this->___callPlugins('getTrackingInfo', func_get_args(), $pluginInfo) : parent::getTrackingInfo();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'formatDeliveryDate');
        return $pluginInfo ? $this->___callPlugins('formatDeliveryDate', func_get_args(), $pluginInfo) : parent::formatDeliveryDate($date);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'formatDeliveryTime');
        return $pluginInfo ? $this->___callPlugins('formatDeliveryTime', func_get_args(), $pluginInfo) : parent::formatDeliveryTime($time, $date);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContactUsEnabled');
        return $pluginInfo ? $this->___callPlugins('getContactUsEnabled', func_get_args(), $pluginInfo) : parent::getContactUsEnabled();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreSupportEmail');
        return $pluginInfo ? $this->___callPlugins('getStoreSupportEmail', func_get_args(), $pluginInfo) : parent::getStoreSupportEmail();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContactUs');
        return $pluginInfo ? $this->___callPlugins('getContactUs', func_get_args(), $pluginInfo) : parent::getContactUs();
    }
